import Node,bubbleSortForLinkedList,insertionSortLinkedList,likedListMergeSort,linkedSelectionSort,quicksortalgorithm
...
def performOperation(list):
    ...
    while performOperation==True:
        ...
        if operation==1:
            ...
            linkedSelectionSort.selectionSort(list)
        elif operation==2:
            print "Bubble sort operation"
            bubbleSortForLinkedList.BubbleSort(list)
        elif operation==3:
            print "Insertion sort operation"
            insertionSortLinkedList.InsertionSort(list)
            list.show()
        elif operation==4:
            print "Merge  sort operation"
            likedListMergeSort.MargeSort(list.start())
            list.show()
        elif operation==5:
            print "Quick sort operation"
            quicksortalgorithm.QuickSort(list.start(),list.last())
            list.show()
        else:
